...
function injectCSS(shadowRoot: ShadowRoot) {
  ...
  link.rel = "stylesheet";
  link.href =
    "https://cdn.jsdelivr.net/gh/Teknik-Komputer-Universitas-Warmadewa/accessibility-widget@v1.0.9/dist/accessibility-widget.css"; // Adjust path based on your setup
